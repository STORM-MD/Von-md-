...
<a href="https://kingvon.tech" target="_blank" style="text-decoration:none;">
  <div style="
    width: 100px;
    height: 100px;
    border-radius: 50%;
    ...
    box-shadow: 0 0 10px #FFD700, 0 0 25px #ff69b4, 0 0 50px #ff1493;
...
@keyframes pulse {
  ...
  50% { box-shadow: 0 0 25px #ff69b4, 0 0 50px #ff1493; }
